(function () {
  ...
  (self["webpackChunkngx_admin"] = self["webpackChunkngx_admin"] || []).push([["src_app_login_login_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _core_services_connection_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      ...
      var _LoginComponent = /*#__PURE__*/function () {
        ...
        _createClass(_LoginComponent, [{
          ...
          value: function onLoginSubmit() {
            ...
            this.authService.login(user).subscribe(function (token) {
              //Check if response was a success or error
              if (!token.success) {
                _this.authService.makeToast("danger", "Failed Logging in", token.message);
                ...
                var decoded = (0, jwt_decode__WEBPACK_IMPORTED_MODULE_0__["default"])(token.token);

                _this.authService.makeToast("success", "Success", token.message);

                _this.authService.storeUserData(token.token, decoded);
      ...
      _LoginComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
        ...
        template: function LoginComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("submit", function LoginComponent_Template_form_submit_6_listener() {
